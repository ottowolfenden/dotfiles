...
QtObject {
    ...
    readonly property var fileFormats: {
        ...
        "custom:file_hash": ["cs", "cshtml", "razor", "csproj"],
        ...
        "custom:file_font": ["abf", "afm", "bdf", "bmf", "brfnt", "fnt", "fon", "mgf", "otf", "pcf", "pfa", "pfb", "pfm", "fond", "sfd", "snf", "tdf", "tfm", "ttf", "ttc", "ufo", "woff", "woff2"],
        ...
        "custom:presentation": ["gslides", "key", "keynote", "nb", "nbp", "odp", "otp", "pez", "pot", "prdx", "pps", "ppt", "pptx", "prz", "sdd", "shf", "show", "shw", "slp", "sspss", "sti", "sxi", "thmx", "watch"],
        "polyline": ["awg", "ai", "cgm", "cdr", "cmx", "dp", "drawio", "dxf", "e2d", "egt", "eps", "fs", "gbr", "odg", "renderman", "svg", "stl", "wrl", "x3d", "sxd", "tgax", "v2d", "vdoc", "vsd", "vsdx", "vnd", "wmf", "emf", "art", "xar"],
        "custom:spreadsheet": ["123", "ab2", "ab3", "aws", "bcsv", "clf", "cell", "gsheet", "numbers", "gnumeric", "lcw", "ods", "ots", "qpw", "pmdx", "sdc", "slk", "stc", "sxc", "tab", "vc", "wk1", "wk3", "wk4", "wks", "wks", "wq1", "xlk", "xls", "xlsb", "xlsm", "xlsx", "xlr", "xlt", "xltm", "xlw"],
