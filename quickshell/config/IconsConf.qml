...
QtObject {
    ...
    readonly property string otherFile: "draft"
    readonly property var fileFormats: {
        ...
        "package_2": ["appx", "app", "dmg", "deb", "hpkg", "ipg", "msi", "rpm", "sis", "sisx", "xap"],
        ...
        "map": ["asc", "apr", "dem", "e00", "geojson", "topojson", "geotiff", "gml", "gpx", "itn", "mxd", "ntf", "ov2", "shp", "tab", "geotiff", "dted", "kml"],
        ...
        "polyline": ["amf", "awg", "ai", "cgm", "cdr", "cmx", "dp", "drawio", "dxf", "e2d", "egt", "eps", "fs", "gbr", "odg", "movie.byu", "renderman", "svg", "stl", "wrl", "x3d", "sxd", "tgax", "v2d", "vdoc", "vsd", "vsdx", "vnd", "wmf", "emf", "art", "xar"],
        "table_chart": ["123", "ab2", "ab3", "aws", "bcsv", "clf", "cell", "csv", "gsheet", "numbers", "gnumeric", "lcw", "ods", "ots", "qpw", "pmdx", "sdc", "slk", "stc", "sxc", "tab", "txt", "vc", "wk1", "wk3", "wk4", "wks", "wks", "wq1", "xlk", "xls", "xlsb", "xlsm", "xlsx", "xlr", "xlt", "xltm", "xlw"],
        ...
        "movie": ["3gp", "aaf", "at3", "gif", "asf", "avchd", "avi", "bik/bk", "braw", "cam", "collab", "dat", "dvr-ms", "flv", "gmv", "mpeg-1", "mpeg-2", "noa", "fla", "flr", "sol", "str", "m4v", "mkv", "wrap", "mng", "mov", "mpeg", "mpg", "mpe", "thp", "mpeg-4", "mxf", "roq", "nsv", "ogg", "qmg", "rm", "rmvb", "svi", "smk", "swf", "wmv", "wtv", "yuv", "webm"],
        ...
        "deployed_code": ["3dmf", "3dm", "3mf", "3ds", "abc", "ac", "amf", "an8", "aoi", "asm", "b3d", "bbmodel", "blend", "block", "bmd3", "bdl4", "brres", "bfres", "bcres", "c4d", "cal3d", "ccp4", "cfl", "cob", "core3d", "ctm", "dae", "dff", "dn", "dpm", "dts", "egg", "fact", "fbx", "g", "glb", "glm", "gltf", "hec", "io", "iob", "jas", "jmesh", "ldr", "lwo", "lws", "lxf", "lxo", "m3d", "ma", "max", "mb", "mpd", "md2", "md3", "md5", "mdx", "mesh", "mesh", "miobject", "miparticle", "mimodel", "mm3d", "mpo", "mrc", "nif", "nwc", "nwd", "nwf", "obj", "off", "ogex", "ply", "prc", "prt", "pov", "r3d", "rwx", "sia", "sib", "skp", "sldasm", "sldprt", "smd", "tres", "u3d", "usd", "usda", "usdc", "usdz", "vim", "vrml97", "vue", "vwx", "wings", "w3d", "x", "x3d", "z3d", "zbmx"],
