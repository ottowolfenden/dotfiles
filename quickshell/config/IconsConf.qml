...
QtObject {
    ...
    readonly property var fileFormats: {
        ...
        "custom:file_config": ["conf", "config", "cfg", "ini", "toml", "ucl", "yaml", "yml", "env", ".buildignore", ".buildignore-sync", "prefs", "prop", "properties", "props"],
        ...
        "folder_zip": ["7z", "ace", "alz", "arc", "arj", "bz2", "cab", "sea", "ecab", "ezip", "flipchart", "fun", "gz", "g3fc", "lawrence", "lbr", "lzh", "lz", "lzo", "lzma", "lzx", "mbw", "mcaddon", "oar", "pak", "par", "par2", "paf", "pea", "pkg", "pyk", "rar", "rax", "sitx", "tar", "wax", "xz", "z", "zoo", "zip", "vsix"],
