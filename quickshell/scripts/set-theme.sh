...
if [ $mode = "dark" ]; then
    ...
    awww img $(/home/otto/dotfiles/scripts/daily-wallpaper.sh dark) --transition-type none
    ...
    awww img $(/home/otto/dotfiles/scripts/daily-wallpaper.sh light) --transition-type none
else
    exit 1
fi
