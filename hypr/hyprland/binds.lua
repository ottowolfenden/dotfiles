...
hl.bind("mouse:275", function() changeWorkspace("focus", -1) end)
hl.bind("mouse:276", function() changeWorkspace("focus", 1) end)
hl.bind("SHIFT + mouse:275", function() changeWorkspace("move", -1) end)
hl.bind("SHIFT + mouse:276", function() changeWorkspace("move", 1) end)
